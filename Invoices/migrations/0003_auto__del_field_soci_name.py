...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Soci.name'
        db.delete_column(u'Invoices_soci', 'name')


    def backwards(self, orm):
        # Adding field 'Soci.name'
        db.add_column(u'Invoices_soci', 'name',
                      self.gf('django.db.models.fields.CharField')(default='d', max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        u'Invoices.emailnotification': {
            ...
            'pointed_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
