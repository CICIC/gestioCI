...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'period', fields ['label']
        db.delete_unique(u'Invoices_period', ['label'])


    def backwards(self, orm):
        # Adding unique constraint on 'period', fields ['label']
        db.create_unique(u'Invoices_period', ['label'])
